...
This repository contains our ML learning pipeline broken down into 4 parts: 
1. Data Preprocessing
2. Exploratory Data Analysis (EDA)
3. Creating Classification Models (Logistic Regression, Decision Trees, Random Forest, KNN, XGBoost)
4. Model Comparison and Final Model Insights
